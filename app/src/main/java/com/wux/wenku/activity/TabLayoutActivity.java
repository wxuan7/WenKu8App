...
//        layoutTab.setTabMode(TabLayout.MODE_SCROLLABLE);
        ...
        sdvDrawerHead.setImageURI(Uri.parse(imageUriCover));
        sdvDrawerHead.setAspectRatio(1.33f);
        SimpleDraweeView tv_head = (SimpleDraweeView) layoutNavigationView.getHeaderView(0).findViewById(R.id.tv_head);
        TextView tv_user = (TextView) layoutNavigationView.getHeaderView(0).findViewById(R.id.tv_user);
        tv_head.setImageURI(Uri.parse(imageUriCover));
